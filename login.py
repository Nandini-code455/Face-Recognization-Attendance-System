...
class Login_Window:
    def __init__(self, root):
        ...
        img1 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\LoginAppIcon.jpeg")
        ...
        img2 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\logo.png")
        img2 = img2.resize((25,25),Image.Resampling.LANCZOS)
        self.photoimage2= ImageTk.PhotoImage(img2)
        lblimg1= Label(image=self.photoimage2,bg="white",borderwidth=0)
        lblimg1.place(x=650,y=323,width=25,height=25)

        img3 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\password.png")
        ...
        #registerbtn
        registerbtn = Button(frame,text="New User Register",command=self.register_window,borderwidth=0,font=("times new roman",10, "bold"),bd=3,relief=RIDGE,fg="black",bg="white",activeforeground="white",activebackground="red")
        registerbtn.place(x=15,y=350,width=160)  

        #forgetpassbutoon
        forgetbtn = Button(frame,text="Forget Password",command=self.forget_password_window,font=("times new roman",10, "bold"),borderwidth=0,bd=3,relief=RIDGE,fg="black",bg="white",activeforeground="white",activebackground="red")
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get()== "":
            ...
            conn=mysql.connector.connect(host="localhost", user="root", password="sona17@8#02NAN",database="face_recognizer")
...
#================================================Reset password========================================================
    def reset_password(self):
        if self.combo_seurity_Q.get()=="Select":
            ...
            value=(self.txtuser.get(),self.combo_seurity_Q.get(),self.txt_security.get(),)
    ...
    def forget_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row == None:
                ...
                l=Label(self.root2,text="Forget Password",font=("times new roman",16,"bold"),fg="red",bg="white") 
                l.place(x=0,y=10,relwidth=1)

                security_Q = Label(self.root2,text="Select Security Questions:",font=("times new roman",15,"bold"),bg = "white",fg="black")
                security_Q.place(x=50,y=80)

                self.combo_seurity_Q = ttk.Combobox(self.root2,font=("times new roman",15,"bold"),state="readonly")
                self.combo_seurity_Q["values"]=("Select","Birth date","Nick Name")
                self.combo_seurity_Q.place(x=50,y=110,width=250)
                self.combo_seurity_Q.current(0)
                ...
                button = Button(self.root2,text="Reset",command=self.reset_password,font=("times new roman",15,"bold"),fg="white",bg="green")
...
class Register:
    def __init__(self, root):
        ...
        self.fname_entry=ttk.Entry(frame,textvariable=self.var_contact,font=("times new roman",15))
        ...
        self.combo_seurity_Q = ttk.Combobox(frame,textvariable=self.var_security_Q,font=("times new roman",15,"bold"),state="readonly")
        self.combo_seurity_Q["values"]=("Select","Birth date","Nick Name")
        self.combo_seurity_Q.place(x=50,y=270,width=250)
        self.combo_seurity_Q.current(0)
        ...
        self.txt_confirmpswd=ttk.Entry(frame,textvariable=self.var_confirmPass,font=("times new roman",15))
        self.txt_confirmpswd.place(x=370,y=340,width = 250)
        ...
        b1.place(x=80, y=450, width=150)  # Updated to match image size

        # Second Button (Login Now)
        ...
        b2.place(x=270, y=450, width=200)  # Adjusted position and width
...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #first image
        img = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\face3.jpg")
        ...
        #second image
        img1 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\facialrecognition.png")
        ...
        #student button
        img4 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\student.jpg")
        img4 = img4.resize((220,220),Image.Resampling.LANCZOS)
        self.photoimg4 = ImageTk.PhotoImage(img4)

        b1= Button(bg_img,image=self.photoimg4,command=self.student_details,cursor="hand2")
        b1.place(x=200,y=100,width=220,height=220) #command = self.student_details connects the student management system to this student button
        ...
        #detect face button
        img5 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\face1.jpg")
        ...
        # Attendance button
        img6 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\attendance.png")
        ...
        #  Help button
        img7 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\helpdesk.jpg")
        ...
        #  Train button
        img8 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\traindata.jpg")
        ...
        #  Photo button
        img9 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\photos.png")
        ...
        #  Developer button
        img10 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\developer.jpg")
        ...
        #  Exit button
        img11 = Image.open(r"C:\Users\nandi\OneDrive\Desktop\Face Recognization Attendance System\College Images\exit.jpg")
    ...
    #===============Function buttons=====================
    #This function connects the student management system with the student button
